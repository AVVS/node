...
#define ERRORS_WITH_CODE(V)                                                    \
  ...
  V(ERR_HTTP2_INVALID_PSEUDOHEADER, TypeError)                                 \
  V(ERR_HTTP2_INVALID_CONNECTION_HEADERS, TypeError)                           \
  V(ERR_HTTP2_HEADER_SINGLE_VALUE, TypeError)                                  \
  V(ERR_INVALID_HTTP_TOKEN, TypeError)                                         \

...
// Amount of potential space we need to reserve for pseudo headers
// refer to HTTP_SPECIAL_HEADERS macro
static constexpr size_t HTTP2_VALID_PSEUDO_HEADERS = 6;
...
class NgHeaders {
 ...
 private:
  ...
  size_t count_;
  size_t offset_ = 0;
  MaybeStackBuffer<char, 4096> buf_;
};
